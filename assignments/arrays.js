...
for(let i = 0; i < inventory.length; i++){
  if(inventory[i].id === 33) {
    //string.length = 50
    //Foreach iteration: i = ?      i < inventory.length   i++   if(inventory[i].id === 33)           
    //1st                   0                         0 < 50 true           1      1 === 33 false                        
    //2nd                 1                          1 < 50 true           2      2 === 33 false                        
    //3rd                  2                          2 < 50 true           3      3 === 33 false 
    //33rd                32                        33< 50 true          34  33 === 33 true              == > console.log                          
    //     }
...
for(let i = 0; i < inventory.length; i++){
  ...
  // car model list is added(push) to the empty array carModels
}
carModels.sort();
// car model list is sort alphabetical order with sort() method
...
for(let i = 0; i < inventory.length; i++){
  ...
  // car year list is added(push) to the empty array carYears 
}
...
for(let i = 0; i < inventory.length; i++){
  if(carYears[i] < 2000){
//  Look for car years less than 2000
oldCars.push(carYears[i])
// car year list is add(push) to the empty array oldCars
  }
}
console.log(oldCars); 
...
// Look throught the array of object with car make of 'BMW' OR 'Audi'
    BMWAndAudi.push(inventory[i].car_make);
// car_make list is add(push) to the BMWAndAudi empty array.
  }
}
